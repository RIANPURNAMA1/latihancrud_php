...
$jumlah_data = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tb_latihan")); // Jumlah total data
...
$query = mysqli_query($koneksi, "SELECT * FROM tb_latihan LIMIT $offset, $jumlah_data_per_halaman");
?>

<div class="container">
  <h3 class="text-start border border-1 p-3 rounded-3 mb-5 fw-light">Halaman Data Siswa</h3>
  <div class="table-container">
    <a href="tambah.php" class="btn btn-success"> <i class="fa-solid fa-plus"></i> Tambah Data</a>
         ...
         <?php foreach($query as $tampil): ?>
            ...
            <tr>
              ...
              <td class="text-center">
                <a class="btn btn-success" href="edit.php?id=<?= $tampil['id']; ?>" onclick="return confirm('apakah anda yakin akan mengedit data ?')"> <I class="fa-solid fa-pen-to-square px-2 text-center"></I>Edit</a>
                <a class="btn btn-danger" href="hapus.php?id=<?= $tampil['id']; ?>" onclick="return confirm('Apakah Yakin Akan Menghapus Data ?')"><I class="fa-solid fa-trash"></I>Hapus</a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php endif; ?>
