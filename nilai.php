...
<div class="container">
  <h3 class="text-start border border-1 p-3 rounded-3 mb-5 fw-light">Data Nilai Ujian</h3>
  <div class="table-container">
    <a href="tambahnilai.php" class="btn btn-success"><i class="fa-solid fa-plus"></i> Tambah Data</a>
         ...
         <?php foreach($query as $tampil): ?>
            ...
            <tr>
              ...
              <td class="text-center">
                <a class="btn btn-success " href="editnilai.php?id_nilai=<?= $tampil['id_nilai']; ?>" onclick="return confirm('apakah anda yakin akan mengedit data ?')"><I class="fa-solid fa-pen-to-square px-2 text-center"></I>Edit</a>
                <a class="btn btn-danger" href="hapusnilai.php?id_nilai=<?= $tampil['id_nilai']; ?>" onclick="return confirm('Apakah Yakin Akan Menghapus Data ?')"> <I class="fa-solid fa-trash"></I> Hapus</a>
              </td>
            </tr>
          <?php endforeach; ?>
        <?php endif; ?>
